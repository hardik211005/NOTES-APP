      ...
      <nav className="bg-gradient-to-r from-slate-800 via-gray-900 to-slate-900 backdrop-blur-lg shadow-2xl border-b border-gray-700/50 sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              <div className="animate-pulse h-10 w-24 bg-gray-700 rounded-xl"></div>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div className="flex items-center space-x-3">
            {!isAuthenticated ? (
              ...
              <>
                ...
                <a 
                  href="/" 
                  className="flex items-center px-4 py-2.5 text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-blue-500/20 hover:to-cyan-500/20 rounded-xl transition-all duration-300 font-medium backdrop-blur-sm border border-transparent hover:border-blue-400/30 group"
                >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-slate-800/95 backdrop-blur-lg rounded-xl shadow-2xl border border-gray-700/50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                    <div className="py-2">
                      ...
                      <a 
                        href="/" 
                        className="flex items-center px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-blue-500/20 transition-colors duration-200"
                      >
                      ...
                      <button 
                        ...
                        className="flex items-center w-full px-4 py-3 text-sm text-red-400 hover:text-red-300 hover:bg-red-500/20 transition-colors duration-200"
                      >
                        <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
